        ...
        <section id="portfolio" className="min-h-screen px-6">
            <div className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center gap-10">
                <div className="space-y-3">
                    <p className="text-sm uppercase tracking-[0.3em] text-violet-300">{t('sections.portfolio.badge')}</p>
                    <h2 className="text-3xl font-semibold sm:text-4xl">{t('sections.portfolio.title')}</h2>
                    ...
                    {PLACEHOLDER_PROJECTS.map((project) => (
                        ...
                        >
                            <p className="text-sm uppercase tracking-wide text-violet-200">
                                {t('sections.portfolio.placeholderSubtitle')}
                            </p>
                            <p className="mt-2 text-2xl font-semibold">
                                {t('sections.portfolio.placeholderTitle', { index: project.titleIndex })}
                            </p>
                        </article>
                    ))}
                </div>
